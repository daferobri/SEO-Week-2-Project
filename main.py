from ticket_events import fetch_events_for_user, show_saved_events
...
def main():
    ...
    while True:
      action = input("Press 's' to Search events, 'v' to view saved events or any other letter to quit: ")
      if action == 's':
